  ...
  return (
    <header className="fixed top-0 w-full">
      <nav className="px-24 max-xl:px-16 max-lg:px-12 max-md:px-8 max-sm:px-4 py-6 flex items-center justify-center">
        <ul className="px-2 py-2 bg-neutral-200/40 backdrop-blur-xl rounded-full text-sm font-medium text-black max-sm:w-full">
          <li className="flex items-center justify-between gap-16 max-sm:gap-6">
